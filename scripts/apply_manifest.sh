...
validate_optional_bool '.features.imageCapture' 'features.imageCapture'
validate_optional_bool '.features.aiPlayground' 'features.aiPlayground'
validate_optional_bool '.features.subscriptions' 'features.subscriptions'
validate_optional_bool '.menu.settings' 'menu.settings'
validate_optional_bool '.menu.aiPlayground' 'menu.aiPlayground'
validate_optional_bool '.menu.subscriptions' 'menu.subscriptions'
validate_optional_bool '.menu.imageCapture' 'menu.imageCapture'
validate_optional_bool '.settings.showDeveloperInfo' 'settings.showDeveloperInfo'
